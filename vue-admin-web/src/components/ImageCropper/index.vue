<template>
  <div class="cropper_model">
    <el-dialog title="图片剪裁" width="710px" class="cropper_model_dlg" :visible.sync="dialogVisible" append-to-body
      ...
      <div class="cropper_content">
        <div class="cropper" style="text-align: center;">
          <vueCropper ref="cropper" :img="options.img" :outputSize="options.outputSize" :outputType="options.outputType"
            ...
            :fixedBox="options.fixedBox" :fixedNumber="options.fixedNumber" @realTime="previewImg">
          </vueCropper>
          <div class="cropper_btns">
            <el-button @click="rotateLeft" icon="el-icon-refresh-left" size="mini" title="左旋转">
            </el-button>
            <el-button @click="rotateRight" icon="el-icon-refresh-right" size="mini" title="右旋转">
            </el-button>
